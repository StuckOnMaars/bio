...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
"Hey, I’m Maarz. I know my shit with Lua and Python. If you need me, hit me up, socials are below.",
"I don't want peace, I want stories worth telling.",
"I'll die a short fun life than live a long boring one."
  ];
  let bioText = '';
  let bioIndex = 0;
